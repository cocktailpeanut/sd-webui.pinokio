...
module.exports = async (kernel) => {
  ...
  if (platform === "darwin") {
    setup = [{
      ...
      method: "shell.run",
      params: { message: "git clone https://github.com/cocktailpeanut/stable-diffusion-webui automatic1111", path: path.resolve(__dirname) },
    }]
  } else {
    ...
    if (test) {
      if (platform === 'win32') {
        ...
        setup = [{
          method: "shell.run",
          params: { message: "git clone https://github.com/cocktailpeanut/stable-diffusion-webui automatic1111", path: __dirname },
        }]
      }
    } else {
      setup = [{
